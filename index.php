...
<body>
    ...
    // ▶ PLAY WHEN ICON CLICKED
    document.getElementById("audioIndicator").addEventListener("click", playWelcomeMessage);

    // ▶ OPTIONAL: Auto play once page loads
    window.onload = playWelcomeMessage;
